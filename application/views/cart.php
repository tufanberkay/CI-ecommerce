...
<tr>
	<td>
		<figure class="itemside align-items-center">
			<div class="aside"><img src="././assets/images/items/11.jpg" class="img-sm"></div>
	...
	<td class="text-right"> 
	<a href="" class="btn btn-danger"> Sepetten Kaldır</a>
	</td>
</tr>
<tr>
	<td>
		<figure class="itemside align-items-center">
			<div class="aside"><img src="././assets/images/items/10.jpg" class="img-sm"></div>
			<figcaption class="info">
...
<tr>
	<td>
		<figure class="itemside align-items-center">
			<div class="aside"><img src="././assets/images/items/9.jpg" class="img-sm"></div>
			<figcaption class="info">
	...
	<aside class="col-lg-3">
		...
		<div class="card-body">
			...
			<a href="./place_order" class="btn btn-primary btn-block"> Ödeme </a>
			<a href="./store" class="btn btn-light btn-block">Alışverişe Devam</a>
		</div> <!-- card-body.// -->
		</div> <!-- card.// -->
