...
<section style="padding-bottom: 170px" class="section-content padding-y bg">
<div class="container">
...
<article class="gallery-wrap"> 
	<div class="img-big-wrap">
	   <a href="#"><img src="./assets/images/items/12.jpg"></a>
	</div> <!-- img-big-wrap.// -->
...
<hr>
	...
	<hr>
	<a href="product_detail.php" class="btn  btn-primary"> <span class="text">Sepete Ekle</span> <i class="fas fa-shopping-cart"></i>  </a>
