...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            <div style="display: flex; align-items: center" class="image">
                <i style="font-size: 18px; color: #fff;" class="fas fa-user-alt"></i>
            </div>
            <div class="info">
                <span style="color: #fff; font-size: 18px" class="d-none d-md-inline"><?php echo ucwords($this->session->userdata('aName')); echo ' '; echo ucwords($this->session->userdata('aLastname'))?></span>
            </div>
        </div>
