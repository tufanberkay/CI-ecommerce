            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown user-menu">
                    <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                        <i style="font-size: 18px" class="fas fa-user-alt"></i>
                        <span class="d-none d-md-inline"><?php echo ucwords($this->session->userdata('aName'))?> </span>
                    </a>
                    <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        <!-- User image -->
                        <li style="display: flex; flex-direction: column; justify-content: center" class="user-header bg-primary">
                            <i style="font-size: 18px" class="fas fa-user-alt"></i>

                            <p>
                                <?php echo ucwords($this->session->userdata('aName'))?>
                                <small>Yetki Tarihi: <?php echo ($this->session->userdata('aDate')) ?> </small>
                            </p>
                        </li>
                        <!-- Menu Body -->
